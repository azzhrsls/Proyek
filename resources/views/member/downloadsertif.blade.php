                ...
                <div class="table-striped">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
                                <th scope="col">Deskripsi Sertifikat</th>
                            </tr>
                        </thead>
                        <tbody class="table-group-divider">
                            <tr>
                                <td>1</td>
                                <td>Sertifikat Webinar Tentang pengelasan</td>
                                <td>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Sertifikat Webinar Tentang pembubutan</td>
                                <td>
                                    <button href="" class="btn btn-primary">Download</button>
                                </td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Sertifikat Webinar Tentang permesinan</td>
                                <td>
                                    <button href="" class="btn btn-primary">Download</button>
                                </td>
                            </tr>
