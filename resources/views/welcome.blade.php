      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center">
            <h1 data-aos="fade-up">Asosiasi Pendidik Teknik Mesin dan Fabrikasi Logam Indonesia</h1>
            <h2 data-aos="fade-up" data-aos-delay="400">Indonesian Manufacture and Fabrication Educators Assosiation (IMFEA)</h2>
    ...
    <main id="main">
        ...
        <div class="container" data-aos="fade-up">
          <header class="section-header">
            ...
            <!-- ======= Features Section ======= -->
    <section id="Deskripsi" class="features">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row feture-tabs" data-aos="fade-up">
          <div class="col-lg-6">
            ...
            <ul class="nav nav-pills mb-3">
              <li>
                <a class="nav-link active" data-bs-toggle="pill" href="#tab1">Tujuan</a>
              </li>
              <li>
                <a class="nav-link" data-bs-toggle="pill" href="#tab2">Fungsi</a>
              </li>
            </ul><!-- End Tabs -->
        ...
        <!-- ======= Team Section ======= -->
        <section id="penguruspusat" class="team">

          <div class="container" data-aos="fade-up">
    
            <header class="section-header">
              <p>Pengurus Pusat</p><br>
              <h2>PERKUMPULAN PENDIDIK TEKNIK MESIN DAN FABRIKASI LOGAM INDONESIA</h2>
            </header>
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="member">
                  ...
                  <div class="member-info">
                    <h4>Moh. Sanni Mufti Alamsyah</h4>
                    <span>Pengawas</span>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                <div class="member">
                  ...
                  <div class="member-info">
                    <h4>Maurine Rumia Esteriani P.</h4>
                    <span>Bendahara</span>
                  </div>
                </div>
              </div>
    ...
    <section id="fasilitas" class="features">
      <div class="container" data-aos="fade-up">
        <div class="row feature-icons" data-aos="fade-up">
          <h3>Fasilitas Yang Tersedia DI IMFEA</h3>
